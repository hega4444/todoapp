...
export default function AddTodo({
  ...
  const getRandomAvailableColor = () => {
    ...
    const availableColors = LIST_COLORS.filter(
      ...
      >
        ...
        <div className="flex justify-end md:justify-start gap-4 items-center">
            ...
            {isDropdownOpen && (
              ...
              >
                <div
                  ...
                  className="p-2 max-h-48 overflow-y-auto no-scrollbar-arrows"
                >
                  {lists.map((list) => (
                    <button
                      key={list.id}
                          ...
                          {LIST_COLORS.map((color) => (
                            <button
                              ...
                              style={{
                                ...
                                border:
                                  selectedColor === color
                                    ? '2px solid var(--color-picker-border)'
                                    : 'none',
                              }}
                            />
                          ))}
          ...
          <button
            ...
            style={{
              backgroundColor: todoText.trim()
                ? `${selectedList?.color}40`
                : 'var(--bg-tertiary)',
              color: todoText.trim()
                ? selectedList?.color
                : 'var(--text-muted)',
              border: todoText.trim()
                ? `1px solid ${selectedList?.color}60`
